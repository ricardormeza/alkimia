  ...
  return (
    ...
    <section className='contenedor py-24 gifs-centrados '>
        <div className=" contenedor-hero-gifs">
            ...
            <div className="marginado">
                <img src={CirculoAzul} className='imgAzul' alt="imagen circulo azul by Alkimia Agency" />
            </div>
        </div>
    </section>
    {/* CTA */}
    <div className="contenido-heroA">
        ...
        <div className="contenido-hero_ctaA">
            <h2 className="fuenteTitulo">Una aleación que logra <br /> resultados increíbles</h2>
